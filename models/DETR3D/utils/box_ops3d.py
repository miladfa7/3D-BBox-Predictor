...
def get_3d_box_old(box_size, heading_angle, center, origin=(0.5, 1.0, 0.5), axis=1):
    dims = box_size
    centers = center
...
def get_3d_box_batch_old(box_size, heading_angle, center):
...
def get_3d_box_batch(box_size, heading_angle, center, origin=(0.5, 1.0, 0.5), axis=1):
    ''' box_size: [x1,x2,...,xn,3] -- box dimensions without flipping [X, Y, Z] -- l, w, h
        heading_angle: [x1,x2,...,xn] -- theta in radians
        center: [x1,x2,...,xn,3] -- center point has been flipped to camera axis [X, -Z, Y]
    Return:
...
def get_3d_box_batch_tensor(box_size, heading_angle, center, origin=(0.5, 1.0, 0.5), axis=1):
    assert isinstance(box_size, torch.Tensor)
    assert isinstance(heading_angle, torch.Tensor)
    assert isinstance(center, torch.Tensor)

    print("get_3d_box_batch_tensor: ", heading_angle)
