...
import numpy as np
import torch
from models.PointPillars.pointpillars.utils import limit_period, iou2d_nearest
...
class Anchors():
    ...
    def get_anchors(self, feature_map_size, anchor_range, anchor_size, rotations):
        ...
        x_centers = x_centers.to(torch.float32)
        y_centers = y_centers.to(torch.float32)
        z_centers = z_centers.to(torch.float32)
