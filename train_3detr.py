...
from models.DETR3D.datasets import build_dataset
from models.DETR3D.engine import evaluate, train_one_epoch
from models.DETR3D.models import build_model
from models.DETR3D.optimizer import build_optimizer
from models.DETR3D.criterion import build_criterion
from models.DETR3D.utils.dist import init_distributed, is_distributed, is_primary, get_rank, barrier
from models.DETR3D.utils.misc import my_worker_init_fn
from models.DETR3D.utils.io import save_checkpoint, resume_if_possible
from models.DETR3D.utils.logger import Logger
...
def make_args_parser():
    ...
    ##### Optimizer #####
    parser.add_argument("--base_lr", default=3e-4, type=float)
    ...
    ##### Dataset #####
    parser.add_argument(
        "--dataset_name", required=True, type=str, choices=["sereact"]
    )
    parser.add_argument(
        "--dataset_root_dir",
        type=str,
        ...
        help="Root directory containing the dataset files. \
              If None, default values from sereact.py are used",
    )
    parser.add_argument(
        "--meta_data_dir",
        type=str,
...
def test_model(args, model, model_no_ddp, criterion, dataset_config, dataloaders):
    print("os.path.isfile(args.test_ckpt): ", os.path.isfile(args.test_ckpt))
